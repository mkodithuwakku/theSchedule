...
- Manager-only clean-run reset that clears UAT data, OAuth links, sessions, and notification deduplication while retaining only the owner manager and an empty schedule
