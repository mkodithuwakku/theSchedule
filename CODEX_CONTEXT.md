...
- Employee-only phone layout below 768px with a compact account header, fixed bottom navigation, touch-sized shift actions, and a vertical team agenda. Manager tools and the existing desktop employee/calendar views remain desktop layouts.
